...
def download_checkpoint(home/stavros/Desktop/image-to-latex-main/1w1abmg1: str) -> None:
    ...
    api = wandb.Api()
    wandb_run = api.run(f"{Desktop/image-to-latex-main/1w1abmg1}")
...
def main() -> None:
    ...
    parser.add_argument("kingyiusuen/image-to-latex/1w1abmg1", type=str)
